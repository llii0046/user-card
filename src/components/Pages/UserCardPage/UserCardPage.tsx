...
const UserCardPage: React.FC = () => {
    ...
    const getMaleUserList = (userInformation: IUserInformation[]) => {
        const maleUserList: IUserInformation[] =
            userInformation.filter(user => user.gender === EUserSex.MALE)
        return maleUserList;
    };

    const getFemaleUserList = (userInformation: IUserInformation[]) => {
        const femaleUserList: IUserInformation[] =
            userInformation.filter(user => user.gender === EUserSex.FEMALE)
